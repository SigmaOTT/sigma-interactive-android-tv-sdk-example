...
public class PlayerActivity extends AppCompatActivity {
    ...
    private String[][] urlChannels = {
            {"c9c2ebfb-2887-4de6-aec4-0a30aa848915", "https://dev-livestream.gviet.vn/manifest/VTV1-PACKAGE/master.m3u8"}
            , {"32a55ed3-4ee1-42f8-819a-407b54a39923", "https://dev-livestream.gviet.vn/manifest/VTV2-PACKAGE/master.m3u8"}
            , {"60346597-8ed9-48de-bd4d-8546d0070c7c", "https://dev-livestream.gviet.vn/manifest/VTV3-PACKAGE/master.m3u8"}
            , {"22e1fdb6-8d10-4193-8411-562c7104aa2b", "https://dev-livestream.gviet.vn/manifest/VTV4/master.m3u8"}};
        ...
        exoPlayer.addListener(new Player.Listener() {
            ...
            public void onPlayerError(PlaybackException error) {
                if (error.errorCode == PlaybackException.ERROR_CODE_BEHIND_LIVE_WINDOW) {
                    Log.d("onPlayerError", "errorCode: " + "ERROR_CODE_BEHIND_LIVE_WINDOW");
    ...
    private void initInteractive(int index) {
        ...
        _interactiveWebview = new SigmaWebView(this);
